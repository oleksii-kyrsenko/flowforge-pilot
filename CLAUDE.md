...
- The map grows via `/spec` ONLY. Mandatory dedup before adding: normalize the value (lowercase hex, unified units; composite values like gradient stops and shadow geometry compare component-wise) and search by VALUE — in the map AND in resolved entries of docs/design-questions.md.
